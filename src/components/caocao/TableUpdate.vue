    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>更新平台条件</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="form-box">
    ...
    export default {
        data: function(){
            return {
              ...
              //url:"http://172.20.15.22:5555/ccdproduct/platform/updatePlatform",
              form: {
                  name: '',
                  region: '',
                  logUrl: ''
        ...
        methods: {
            ...
            getDataQueryName(Id){
              ...
              //self.$axios.get("http://172.20.15.22:5555/ccdproduct/platform/queryPlatformById?platformId="+Id).then((res) => {
