        ...
        methods: {
            getData(Id){
                ...
                //self.$axios.get("http://172.20.15.22:5555/ccdproduct/productFiltrate/queryPlatformById?productFiltrateId="+Id).then((res) => {
                      ...
                      let FiltrateType=res.data.content.filtrateType;
                      this.form.name=res.data.content.productFiltrateName;
                    //  this.form.Type=res.data.content.filtrateType;
                      ...
                      if(FiltrateType=="1"){ this.form.Type="正序";}
                      else if(FiltrateType=="2"){ this.form.Type="倒序";}
