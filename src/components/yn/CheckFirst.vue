    ...
    <div class="table">
       ...
       <div class="first">初审列表(Susunan verifikasi pertama)</div>
        <el-table :data="data" border style="width: 100%"  :row-class-name="tableRowClassName" ref="multipleTable">
            <el-table-column  prop="index"  label="序号(Nomor urutan)"  width="150" >  </el-table-column>
        ...
        methods: {
           ...
           handleSizeChange(val) {
            ...
            handleRead(index,row){
                ...
                this.$router.push({ path: 'checkdetail', query: { listingId: row.listingId, userId:row.userId}});
            }
        }
    }
</script>
